({
    doInit : function(component, event, helper) {
		...
		helper.loadIntersectionDetails(component);
    ...
    onSelectRecordTypeChange : function(component, event, helper){
        ...
        component.set("v.newEvent.Description", "");
        helper.loadRecordTypeId(component);
        helper.loadDefaultEventType(component);
        helper.loadEventTypes(component);
        if(recType == $A.get("$Label.c.BST_Field_Sales_Call_RecordType") || recType == $A.get("$Label.c.BST_Training_Provided_RecordType") || recType == $A.get("$Label.c.BST_Non_Field_Sales_Activity_RecordType")) {
        	helper.loadMainProductCategoryValues(component);
        }
    },
    ...
    onSelectMPCChange : function(component, event, helper){
        ...
        if((recType == $A.get("$Label.c.BST_Field_Sales_Call_RecordType") || recType == $A.get("$Label.c.BST_Training_Provided_RecordType") || recType == $A.get("$Label.c.BST_Non_Field_Sales_Activity_RecordType")) && mpc != '') {
    ...
    onChangeStartDate : function(component, event, helper){
        ...
        var startDateTime = component.find("eventStartDate").get("v.value");
        console.log('###startDateTime: '+ startDateTime);
        var newDateTime = component.find("eventEndDate");
        newDateTime.set("v.value", startDateTime);
    },
